...
<head>
  ...
  <!-- Custom CSS -->
  <link rel="stylesheet" href="assets/css/superadmin/superadmin_settings.css">
</head>
<body>
  <!-- Include Sidebar -->
      ...
      <div class="topbar-actions">
        ...
        <div class="dropdown">
          ...
          <div class="dropdown-menu dropdown-menu-end profile-menu" aria-labelledby="profileDropdown">
            <a href="superadmin_settings.php" class="dropdown-item"></a>
  ...
  <!-- Custom JS -->
  <script src="assets/js/superadmin/superadmin_settings.js"></script>
</body>
</html> 